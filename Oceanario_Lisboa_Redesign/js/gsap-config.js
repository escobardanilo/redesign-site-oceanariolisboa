 ...
 * Deliberately varied per docs/ANIMATIONS.md: not every timeline should
 * use the same duration/ease, or the whole site starts to feel metronomic.
 */
export const EASE = {
  standard: 'power3.out',
  soft: 'power2.out',
 ...
 * Skipped entirely for reduced-motion users and for coarse/touch pointers,
 * where native momentum scrolling already feels right and is cheaper.
 */
...
/** Pause/resume Lenis — used by the fullscreen menu and modals to lock scroll. */
